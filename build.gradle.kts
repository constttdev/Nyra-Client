...
dependencies {
    ...
    includeImplementation("com.kohlschutter.junixsocket:junixsocket-common:2.11.0")
    includeImplementation("com.kohlschutter.junixsocket:junixsocket-native-common:2.11.0")
    includeImplementation("com.kohlschutter.junixsocket:junixsocket-core:2.11.0")
